...
- [Agent Skills and APM](./docs/en/guide/codex-skills.md)
...
remote manifest files are downloaded to the same cache, and project checkouts
use `~/repos/<host>/<repo-path>` paths such as
