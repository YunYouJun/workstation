...
> All VS Code extensions I installed.
...
- [phr0s.bib](https://marketplace.visualstudio.com/items?itemName=phr0s.bib): BibTeX syntax highlighting; useful when writing papers.
